...
class B2962A(ATEBase):
    ...
    def set_source_function(
        self, func: SourceFunction, compliance: float, channel: int = 1
    ) -> None:
    ...
    def set_measurement_function(
        self, func: MeasurementFunction, channel: int = 1
    ) -> None:
    ...
    def set_aperture_time(
        self, time: float, channel: int = 1, mode: str = "VOLT"
    ) -> None:
